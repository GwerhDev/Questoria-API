...
module.exports = {
  ...
  apiUrl: this.environment === production ? process.env.API_URL_PROD : process.env.API_URL,
  clientUrl: this.environment === production ? process.env.CLIENT_URL_PROD : process.env.CLIENT_URL,
